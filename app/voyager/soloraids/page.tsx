  ...
  async function sendTransaction(account: AccountData) {
    ...
    txb.moveCall({
      ...
      arguments: [
        mintCoin,
        txb.pure(
          "0x77e7315c2596780aa90a0485d6be17be85cbcc28421df59b91ae654b428c7999"
        ),
      ],
    });
      ...
      <div className="flex min-h-screen">
        <aside className="bg-[#75E2FF] w-80 p-12">
          <div className="mb-6 bg-white p-4 rounded-2xl">
            ...
            <a href="/voyager/createEvent">
              <button className="w-[80%] bg-black text-white py-2 rounded mt-6">
                + Create a Raid
              </button>
            </a>
          </div>
          <div className="mb-6 bg-white p-4 rounded-2xl">
            ...
            <a href="/voyager/profile">
              <h2 className="text-lg mb-2 mt-8">
                <span className="text-4xl float-right">↗</span>Solo raid I am
                Attending{" "}
              </h2>
            </a>
          </div>
